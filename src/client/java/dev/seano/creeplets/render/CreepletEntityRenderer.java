...
public class CreepletEntityRenderer extends MobEntityRenderer<CreepletEntity, CreepletEntityModel<CreepletEntity>> {
    ...
    public CreepletEntityRenderer(EntityRendererFactory.Context context, EntityModelLayer layer) {
        super(context, new CreepletEntityModel<>(context.getPart(layer)), 0.5f);
    }
